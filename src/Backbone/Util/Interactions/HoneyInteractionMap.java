...
* @since       2013-10
*/
public class HoneyInteractionMap extends InteractionMap {
    public HoneyInteractionMap(int R, int dim){
        super();
        if(R > 0){
            initMap(R,dim);
        // nearest neighbor
    ...
    private void initMapNN(int dim){
        if (dim != 2){
            throw new IllegalArgumentException("HoneyInteractionMap | Only 2D allowed.");
        }
