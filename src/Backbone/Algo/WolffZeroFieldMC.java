 ...
 * @since       2012-08    
 */
public class WolffZeroFieldMC implements IsingMC{
    ...
    */
    public WolffZeroFieldMC(MCSimulation mc, boolean out){
        ...
        if(mc.getSimSystem().getClass().getName().contains("attice")){
            ...
            System.err.println("THIS CLASSS (WOLFFZEROFIELDMC NEEDS A LATTICE AS SYSTEM.");
        }
        ...
        perimeterSpins = new ArrayList<Integer>();
    }
    ...
    private void seedSpin(){
        ...
        while(attemptAgain){
            ...
            attemptAgain=false;
            if(lattice.isThisFixed(x, y, 0)){attemptAgain=true;}
        }
    ...
    private int popFromPerimeter(){
        ...
        perimeterSpins.set(0,perimeterSpins.get(perimeterSpins.size()-1));        
        perimeterSpins.remove(perimeterSpins.size()-1);
        return head;
    }
    ...
    */ 
    public void doOneStep(){
        ...
        calcBondProb();
        //System.out.println("Bond Prob: "+bondProbability);
