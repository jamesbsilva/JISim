...
import java.util.ArrayList;
 ...
 /**  
 *      OFC monte carlo simulation interface to be implemented 
...
public interface OFCMC extends MCAlgo{
    ...
    */
    ...
    /**
    *   getMaxStressLoc should return the current max stress location.
    * 
    */
    public int getMaxStressLoc();
    /**
    *   getStressTotal should return the current total stress.
    * 
    */
