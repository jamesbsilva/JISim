...
* @since       2012-11    
*/
public class NetworkER implements Network{
    ...
    private String degreeOutFname ="Degree/degreeDataER-";
    private Random Ran = new Random();
   
    public NetworkER(){}
    
    public NetworkER(int nodes,double p, String fixPost, boolean heter,int se){
        seed = se;
        useHeter = heter;
        setNetworkSeed(seed);
        System.out.println("Seed Links: "+seedBonds+"     seed vals: "+seedVals);
        degreeOutFname += "N-"+nodes+"-prob-"+p+"-seed-"+seed+".txt";
        fixedFname = fixPost;
        initialize(nodes,p,+1);
        connectNetwork();
        sortNetworkByDegree();
    }
    
    public NetworkER(int nodes,double p, String fixPost, boolean heter){
    ...
    private void initialize(int nodes, double p, int s){
        N = nodes;
        s0=s;
        bondProb = p;
        if(networkBonds ==  null){networkBonds = new HashMap<Integer,ArrayList<Integer>>();}
    ...
    */ 
    public void setFixedNetworkValues(){
        ...
        System.out.println("Opening fixed: "+fileName);
	...
	try {
        ...
        //System.out.println("NetworkER | Nodes fixed in network : "+nfixed+"    M: "+magnetization.get());
    }
    ...
    */ 
    ...
    public static void main(String[] args) {
        NetworkER network = new NetworkER(1000,0.25,"",false);
