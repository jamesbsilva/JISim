...
* @since Apr 28, 2012
*/
public final class LatticeCLOpti implements LatticeMagInt {
    private int L = 256;
    private int N;
    ...
    */
    public LatticeCLOpti(int length,int rad, int dim,int g,int s, CLHelper cl){        
        clhandler = cl;
        ...
        if(Geo==2 || Geo == 4){
            ...
            System.err.println("LatticeCLOpti | TRIANGULAR/HONEYCOMB LATTICE NOT SUPPORTED: DEFAULTING TO SQUARE");
        }else{
            System.err.println("LatticeCLOpti |  LATTICE NOT SUPPORTED");
        }
    ...
    */
    public LatticeCLOpti(int s, CLHelper clhandler){
    ...
    */ 
    public LatticeCLOpti(int s, int id, CLHelper clhandler){
    ...
    */ 
    public LatticeCLOpti(int s,String postfix, CLHelper clhandler){
    ...
    *  @param id - instance id of currently running instance of program
    */ 
    public LatticeCLOpti(int s,String postfix,int id, CLHelper clhandler){
    ...
    *  @param id - instance id of currently running instance of program
    */ 
    public LatticeCLOpti(int s,String postfix,String fixedpost,int id, CLHelper clhandler){
    ...
    *  @param id - instance id of currently running instance of program
    */ 
    public LatticeCLOpti(int s,String postfix,String fnamepost,int id, CLHelper cl,String kernel, int argn, int arg2){
        clhandler = cl;
    ...
    *  @param id - instance id of currently running instance of program
    */ 
    public LatticeCLOpti(int id, CLHelper cl,String kernel, int argn){
    ...
    *  @param id - instance id of currently running instance of program
    */ 
    public LatticeCLOpti(String postfix,String fnamepost,int id, CLHelper cl,String kernel, int argn){
    ...
    */ 
    public synchronized void setFixedLatticeValues() {
        ...
        System.out.println("LatticeCLOpti | Getting fixed from : "+fileName);
    ...
    */
    public synchronized void setInitialConfig(int t, int run, String post) {	 
        System.out.println("LatticeCL | getting kernel arguments for : "+metropolisKernel);
        IntBuffer spinBuff = (IntBuffer) clhandler.getArgHandler().getDirectIntBuffer(metropolisKernel, 0);
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        LatticeCLOpti lat = new LatticeCLOpti(4,1,2,2,1,clhandler);
